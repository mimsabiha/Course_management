	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		 ...
		 <div class="navbar-nav ml-auto">
				<form class="form-inline" method="post" action="Teacher">
					<button type="submit" class="btn btn-info">assigned courses</button>
				</form>
			</div>
	</nav>
			...
			<tbody>
				<c:forEach items="${requestScope.courses}" var="i">
					<tr>
						...
						<td>${i[2]}</td>
						<td>
							<form class="form-inline" method="post" action="EnrolledStudents">
