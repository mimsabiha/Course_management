		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			...
			<div class="navbar-nav ml-auto">
				...
				<form class="form-inline" method="post" action="Student">
					<button type="submit" class="btn btn-info">My courses</button>
				</form>
			</div> 
				<a class="nav-item nav-link active"
					href="http://localhost:8082/WebTech/Enroll">Enroll for
					courses</a>
			</div>
		</div>
	</nav>
					...
					<tr>
						...
						<td>
							<form class="form-inline" method="post" action="EnrollCourse">
								...
								<input type="hidden" name="course_name" value="${i[1]}">
								<input type="hidden" name="course_teacher" value="${i[2]}">
